package com.ngotrieuvi544.driverlicense.screen.exam.infodialog
...
import com.ngotrieuvi544.driverlicense.data.model.CreateExamRules
import com.ngotrieuvi544.driverlicense.databinding.DialogExamInfoBinding
...
object ExamInfoDialog {
    ...
    fun showExamInfoDialog(context: Context?, createExamRules: com.ngotrieuvi544.driverlicense.data.model.CreateExamRules) {
        context?.let { context ->
            if (dialog == null) {
