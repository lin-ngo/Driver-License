...
import com.ngotrieuvi544.driverlicense.data.model.QuestionType
...
import com.ngotrieuvi544.driverlicense.data.model.findCreateExamRuleByLicenseType
import com.ngotrieuvi544.driverlicense.data.model.findCreateExamRuleByLicenseTypeString
import com.ngotrieuvi544.driverlicense.data.model.getAllLowerQuestionList
...
import com.ngotrieuvi544.driverlicense.utils.CountDownInstance
...
import com.ngotrieuvi544.driverlicense.utils.constant.AppConstant.FIRST_INDEX
    ...
    fun processFinishExamEvent(onFinishExamEvent: () -> Unit) {
        launchTask {
            ...
            currentExam?.let { exam ->
                ...
                val examRules =
                    com.ngotrieuvi544.driverlicense.data.model.findCreateExamRuleByLicenseType(
                        sharedPreferences.getCurrentLicenseType()
                    )
